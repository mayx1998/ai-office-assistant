...
| 文件 | 内容 |
|---|---|
| [docs/项目总结-MCP办公助手.md](docs/项目总结-MCP办公助手.md) | 项目全记录：核心概念、四天架构演进、8 个调试案例、面试问答 |
| [docs/Day5工程化学习总结.md](docs/Day5工程化学习总结.md) | 工程化六能力详解 + 5 个真实踩坑案例 |
